...
Eigen::Vector3d Viewer3D::color_preset(int code)
{
    ...
    std::map<int, std::function<void()>> color_func = {
        ...
        {4, [&color]
         { color = {0, 0, 0.9}; }},
        {5, [&color]
         { color = {0.592, 0.976, 0.976}; }},
        {6, [&color]
         { color = {0.643, 0.871, 0.976}; }},
        {7, [&color]
         { color = {0.757, 0.878, 0.969}; }},
        {8, [&color]
         { color = {0.812, 0.729, 0.882}; }},
        {9, [&color]
         { color = {0.773, 0.624, 0.788}; }},
        {10, [&color]
         { color = {0.106, 0.184, 0.200}; }},
        {11, [&color]
         { color = {0.157, 0.314, 0.180}; }},
        {12, [&color]
         { color = {0.278, 0.408, 0.173}; }},
        {13, [&color]
         { color = {0.549, 0.439, 0.318}; }},
        {14, [&color]
         { color = {0.937, 0.188, 0.329}; }}};
